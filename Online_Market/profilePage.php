...
<html>
    ...
    <body style="background-color:#101010;">
        ...
        <div class="head" style="border-style: solid; background-color:#FFFFFF;"> 
                      ...
                      <div class="container-fluid">  
                           <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"> 
                            <ul class="nav navbar-nav">
                               <li class="active"><a href="/online_market/profilePage.php">My Account</a></li>
            ...
            <br><br> 
                <table class="contain" border="4"> 
                  <tr><ul> 
                   <a href="/online_market/add_category.php">Click to Add a new Category</a> 
                  </ul></tr> 
                </table>
                <div id="userads" align="center">
                    <table cellpadding="5" class="contain">
                            <form name="home" method="post" class="contain">
                              <center><label for="name" class="labelname"> Your ads and category </label></center>
                              ...
                              for($i=0 ; $i<count($arr) ; $i++){ 
                                    ...
                                    echo "<tr><center><button type=\"button\" onclick='f1(this)' value=".$arr[$i]->getId()." style=\"background-color: green; color: white;\" name=\"show\">click here to view the ad with details</button></center></tr>";
